...
class Student:
    def __init__(self,root):
        ...
        #-----Title-----
        title=Label(self.root,text="Manage Student Details",compound=LEFT,font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=35)
        #-----Variables-----
        ...
        self.CourseTable.column("contact",width=80)
        self.CourseTable.column("admission",width=100)
        self.CourseTable.column("course",width=100)
        self.CourseTable.column("state",width=100)
        self.CourseTable.column("city",width=100)
        self.CourseTable.column("pin",width=60)
    ...
    def search(self):
        ...
        try:
            if self.var_search.get() == "":
                messagebox.showerror("Error", "Enter roll no to search", parent=self.root)
            else:
